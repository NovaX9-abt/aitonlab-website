      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            {/* Contact Form */}
            <div className="md:col-span-3 animate-slide-up" style={{
            animationDelay: "0.2s"
          }}>
              <Card className="p-8 shadow-elegant">
                <form onSubmit={handleSubmit} className="space-y-6">
                  {error && <div className="p-3 rounded-md bg-destructive/10 border border-destructive/20 text-destructive text-sm">
                      {error}
                    </div>}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="businessName" name="businessName" placeholder="Your Business Name" required maxLength={100} />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="phone">Phone Number *</Label>
                    <Input id="phone" name="phone" type="tel" placeholder="+250 XXX XXX XXX" required maxLength={20} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" name="message" placeholder="Tell us about your business needs..." maxLength={1000} rows={4} className="resize-none" />
                  </div>
